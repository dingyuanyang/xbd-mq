...
public class ReceiveTopic2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        for (String routingKey : routingKeys) {
            ...
            System.out.println("ReceiveTopic2 exchange:" + RabbitMQConstants.EXCHANGE_TOPIC_NAME + ", queue:" + queue + ", BindRoutingKey:" + routingKey);
        }
        System.out.println("ReceiveTopic2 waiting for msg");
        Consumer consumer = new DefaultConsumer(channel) {
            @Override
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                String msg = new String(body, "utf-8");
                System.out.println("ReceiveTopic2 get message -->" + envelope.getRoutingKey() + ":" + msg);
            }
        };
