...
public class RoutingReceiveDirect2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        System.out.println("RoutingReceiveDirect2 waiting for error message");
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag,
                ...
                System.out.println("RoutingReceiveDirect2 get message -->" + envelope.getRoutingKey() + ":" + msg);
            }
